...
const FigureGraphModule = (() => {
  ...
  function _buildDOM() {
    ...
    _overlay.innerHTML = `
      <div id="fg-topbar">
        <button id="fg-back-btn" aria-label="กลับ"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" width="18" height="18"><path d="M15 18l-6-6 6-6"/></svg></button>
