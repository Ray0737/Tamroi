...
| 🏆 | `fig-s-10` | King Naresuan the Great | สมเด็จพระนเรศวรมหาราช (พระองค์ดำ) | อยุธยา (ayutthaya) | No | 14.3692, 100.5878 | Defeated Burmese Prince Mingyi Swa in a legendary elephant duel in 1593, ending decades of Burmese domination over Ayutthaya. Restored Siamese sovereignty. |
...
| ⚔️ | `fig-s-01` | King Taksin the Great | สมเด็จพระเจ้าตากสินมหาราช (สิน) | พระนคร (rattanakosin) | **Yes** | 13.7479, 100.4918 | Reunited Siam after the fall of Ayutthaya in 1767; founded the Thonburi Kingdom and expelled the Burmese invaders. Reigned 1767–1782. |
| ⚓ | `fig-s-17` | Prince Chumphon | พระเจ้าบรมวงศ์เธอ กรมหลวงชุมพรเขตอุดมศักดิ์ (อาภากรเกียรติวงศ์) | บางรัก/สีลม (silom) | No | 13.7270, 100.5230 | "Father of the Royal Thai Navy"; modernized naval forces, founded the Naval Cadet School, introduced modern naval warfare doctrines. Deeply venerated as a protective deity. |
| 📚 | `fig-s-20` | Prince Damrong Rajanubhab | กรมพระยาดำรงราชานุภาพ (ดิศวรกุมาร) | ดุสิต (dusit) | No | 13.7735, 100.5015 | "Father of Thai History." Founded the National Library, National Museum, and modern Thai education system. As Minister of Interior under Rama V, restructured provincial administration still foundational today. |
| 🎨 | `fig-s-18` | Prince Naris | สมเด็จเจ้าฟ้ากรมพระยานริศรานุวัดติวงศ์ (จิตรเจริญ) | พระนคร (rattanakosin) | No | 13.7480, 100.4870 | Versatile genius — architect, painter, composer, poet. Designed Wat Benchamabophit (Marble Temple, 1899–1911); led the 1926–1932 restoration of the Chakri Maha Prasat throne hall's roof spires. |
...
| ⚖️ | `fig-b-15` | ~~Prince Rabi Bodhanabaya~~ *(removed 2026-07-15)* | ~~พระเจ้าบรมวงศ์เธอ กรมหลวงราชบุรีดิเรกฤทธิ์~~ | — | — | Removed — see `supabase/patch_remove_royal_dusit_pair.sql`. Replaced by `fig-a-22`/`fig-a-23`. |
| 🏛️ | `fig-a-22` | Mario Tamagno | มาริโอ ตามัญโญ | ดุสิต | 13.7723, 100.5148 | Italian court architect (entered Siamese service 1900). Chief designer of Ananta Samakhom Throne Hall — later Thailand's first Parliament House — plus Amphorn Sathan Residential Hall, Government House, and Hua Lamphong Railway Station. *(added 2026-07-15, replaces `fig-b-15`)* |
| 🏢 | `fig-a-23` | Field Marshal Sarit Thanarat | จอมพลสฤษดิ์ ธนะรัชต์ | ดุสิต | 13.7658, 100.5158 | Prime Minister who governed from Government House, Dusit (1959–1963). Established the National Economic Development Board (now NESDB) and National Education Council in 1959. *(added 2026-07-15, replaces `fig-a-17`)* |
| ☸️ | `fig-b-02` | Prince-Patriarch Vajiranana Varorasa | สมเด็จพระมหาสมณเจ้า กรมพระยาวชิรญาณวโรรส (พระองค์เจ้ามนุษยนาคมานพ) | พระนคร | 13.7592, 100.5011 | Supreme Patriarch who reformed the Thai Sangha, standardized the Buddhist curriculum, founded Mahamakut Buddhist University; authored the first standardized Pali-Thai dictionary. *(reclassified B→A 2026-07-13)* |
...
| 👸 | `fig-a-19` | Queen Suvadhanā | พระนางเจ้าสุวัทนา พระวรราชเทวี (เครือแก้ว อภัยวงศ์) | ดุสิต | 13.7760, 100.5090 | Last royal consort of King Vajiravudh (Rama VI), married 1924; gave birth to Princess Bejaratana the day before the King's death. *(reclassified A→B 2026-07-13)* |
...
| `lore-rangsit-canal` | Rangsit Canal | rangsit | 14.0680, 100.6040 | 100 | 25 |
| `lore-rangsit-agriculture` | Rangsit Agricultural Development | rangsit | 14.0740, 100.6090 | 100 | 25 |
| `lore-rangsit-name-origin` | The Name "Rangsit" | rangsit | 14.0700, 100.6110 | 100 | 25 |
...
- `quiz_questions`: 174 rows (172 + 6 added 2026-07-15 for `fig-a-22`/`fig-a-23` − 4 removed with `fig-b-15`/`fig-a-17`).
- 74 figures total (73 + `fig-a-21` + `fig-a-22` + `fig-a-23` − `fig-b-15` − `fig-a-17`, all 2026-07-15). All have `lat`/`lng` populated — the old "47 of 74 figures have no coords" fallback-pin situation from the 2026-07-05 snapshot no longer applies. `fig-b-15` (Prince Rabi Bodhanabaya) and `fig-a-17` (Prince Dhani Nivat) removed per user request (no-monarchy pass on the dusit roster); replaced by non-royal `fig-a-22` (Mario Tamagno) and `fig-a-23` (Field Marshal Sarit Thanarat) — see `supabase/patch_remove_royal_dusit_pair.sql`.
...
**Part 1 — `lore-gp-1`** The Upper Terrace of Wat Phra Kaew *(revised 2026-07-15 — dropped mystery-box framing, fact-corrected the third building)*
- Previous text named the third building the "ubosot enshrining the Emerald Buddha" — incorrect; the ubosot is a separate ground-level building. The third upper-terrace structure is **Prasat Phra Thep Bidon**, built 1855 under Rama IV, originally meant to house the Emerald Buddha but found too small, rededicated 1903 as the Royal Pantheon (Chakri kings' bronze statues), open to the public only on Chakri Memorial Day (6 April).
- TH: บนฐานไพทีแห่งนี้ประดิษฐานอาคารสามหลังจากสามรัชสมัย มีรูปแบบสถาปัตยกรรมแตกต่างกันโดยสิ้นเชิง ได้แก่ พระศรีรัตนเจดีย์ทรงลังกาบุทองคำ พระมณฑปยอดแหลมซึ่งใช้เป็นที่เก็บพระไตรปิฎก และปราสาทพระเทพบิดร ปราสาทจตุรมุขที่สร้างขึ้นในรัชสมัยพระบาทสมเด็จพระจอมเกล้าเจ้าอยู่หัวเมื่อ พ.ศ. 2398 เดิมมีพระราชประสงค์ให้เป็นที่ประดิษฐานพระพุทธมหามณีรัตนปฏิมากร แต่ด้วยขนาดที่คับแคบเกินไป จึงเปลี่ยนวัตถุประสงค์ในการปฏิสังขรณ์เมื่อ พ.ศ. 2446 ให้เป็นที่ประดิษฐานพระบรมรูปหล่อสมเด็จพระบูรพมหากษัตริยาธิราชแห่งราชวงศ์จักรี เปิดให้ประชาชนเข้าถวายบังคมได้เพียงปีละครั้งในวันจักรี (6 เมษายน) วัดพระศรีรัตนศาสดารามเป็นวัดหลวงเพียงแห่งเดียวในประเทศไทยที่ไม่มีพระภิกษุจำพรรษา เนื่องจากพระบาทสมเด็จพระพุทธยอดฟ้าจุฬาโลกมหาราชทรงมีพระราชประสงค์ให้เป็นเพียงที่ประดิษฐานพระพุทธรูปคู่บ้านคู่เมืองเท่านั้น
- EN: The upper terrace holds three structures from three different reigns, each in a distinct architectural style: the gold-clad, Ceylonese-style Phra Sri Rattana Chedi; the spired Phra Mondop, built to house the Tripitaka; and Prasat Phra Thep Bidon, a four-porched pavilion built under King Mongkut (Rama IV) in 1855. It was originally intended to enshrine the Emerald Buddha, but proved too small for the purpose; following renovation in 1903 it was rededicated as the Royal Pantheon, housing bronze statues of the Chakri dynasty's kings, opened to the public only once a year on Chakri Memorial Day (6 April). Wat Phra Kaew remains the only royal temple in Thailand with no resident monks, as King Rama I intended it solely as the shrine of the kingdom's most sacred image.

**Part 2 — `lore-gp-4`** Queen Sirikit Museum of Textiles *(revised 2026-07-15 — "used to be / now is" structure, dropped conversational transition)*
- TH: อาคารรัษฎากรพิพัฒน์เดิมสร้างขึ้นในรัชสมัยพระบาทสมเด็จพระจุลจอมเกล้าเจ้าอยู่หัวราวทศวรรษ 2410 เพื่อใช้เป็นที่ทำการกรมพระคลังและกรมศุลกากร ต่อมาใน พ.ศ. 2546 สมเด็จพระนางเจ้าสิริกิติ์ พระบรมราชินีนาถ ทรงขอพระราชทานพระบรมราชานุญาตใช้อาคารซึ่งว่างเปล่าอยู่ในขณะนั้นเพื่อจัดตั้งเป็นพิพิธภัณฑ์ผ้า ภายหลังการบูรณะครั้งใหญ่ พิพิธภัณฑ์ผ้าในสมเด็จพระนางเจ้าสิริกิติ์ พระบรมราชินีนาถ จึงเปิดให้เข้าชมอย่างเป็นทางการในเดือนพฤษภาคม พ.ศ. 2555 จัดแสดงประวัติศาสตร์สิ่งทอไทยและงานหัตถศิลป์การทอผ้าจากทั่วประเทศ อาคารหลังนี้จึงเปลี่ยนบทบาทจากที่ทำการราชการด้านการคลัง มาเป็นสถานที่รักษามรดกหัตถศิลป์ของแผ่นดิน
- EN: The Ratsadakorn-bhibhathana Building was originally constructed in the 1870s, in the reign of King Chulalongkorn (Rama V), to house the Royal Treasury and Customs Departments. In 2003, Queen Sirikit requested royal permission to repurpose the then-vacant building as a textile museum. Following extensive renovation, the Queen Sirikit Museum of Textiles officially opened in May 2012, exhibiting the history of Thai textiles and weaving craftsmanship from across the country. The building's role has thus shifted — from a government finance office to a permanent home for the kingdom's textile heritage.
